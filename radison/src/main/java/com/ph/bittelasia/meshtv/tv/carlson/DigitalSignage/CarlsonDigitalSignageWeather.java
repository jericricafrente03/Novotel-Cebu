...
@Layout(R.layout.bittel_layout_1_weather)
@DataSetting()
public class CarlsonDigitalSignageWeather extends MeshTVFragment<MeshWeatherV2> implements
        MeshWeatherListener,
        MeshRealmListener,
        MeshConfigListener
{
    //============================================Variable==========================================
    //--------------------------------------------Constant------------------------------------------
    public static final String TAG = CarlsonDigitalSignageWeather.class.getSimpleName();
    //----------------------------------------------------------------------------------------------
    //----------------------------------------------View--------------------------------------------
    ...
    @BindWidget(R.id.tv_description)
